...
-- dodatkowo, gdybym miała tabele wypozyczenie_id, ksiazka, auto, czytelnik to czytelnik może mieć kilka wypozyczonych książek, 
-- a więc byłaby zależność wielowartościowa, nalezy wtedy rozdzielić tabele na ksiazka_id, tytul, autor oraz wypozyczenie_id, ksiązka_id, czytelnik 
